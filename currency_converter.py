...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        self.converted_amount_field_label = Label(self, text= '', fg='white', relief= tk.RIDGE, justify=tk.CENTER, width=17, borderwidth=3)

        self.from_currency_variable = StringVar(self)
        self.from_currency_variable.set('NGN')
        self.to_currency_variable = StringVar(self)
        self.to_currency_variable.set('USD')

        font = ('Courier', 12, 'bold')
        self.option_add('*TCombobox * Listbox.font', font)
        self.from_currency_dropdown = ttk.Combobox(self, textvariable=self.from_currency_variable, values=list(self.currency_converter.currencies.keys()), font=font, state= 'readyonly', width=12, justify= tk.CENTER)
